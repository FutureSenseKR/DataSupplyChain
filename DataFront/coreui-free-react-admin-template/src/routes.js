...
const Search = React.lazy(() => import('./views/theme/serach/Search'))
const Create = React.lazy(() => import('./views/theme/create/Create'))
...
const routes = [
  ...
  { path: '/theme', name: 'Theme', component: Search, exact: true },
  { path: '/theme/search', name: 'Colors', component: Search },
  { path: '/theme/create', name: 'Typography', component: Create },
